...
<head>
	<title>Top Click Task Manager</title>
	<!--/tags -->
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						<h3>Improving workplace <span style="color:snow">Productivity.</span></h3>
			...
			<div class="item item2">
				<div class="container">
					<div class="carousel-caption">
						<h3>Inspiring leadership <span style="color:tomato">innovation.</span></h3>
						<p>Hire. Train. Retain.</p>
			...
			<div class="item item3">
				<div class="container">
					<div class="carousel-caption">
						<h3>Improving workplace <span style="color:tomato">Productivity.</span></h3>
						<p>Hire. Train. Retain.</p>
...
{               ?>
				<div class="col-md-6 banner_bottom_left">
					<h4>Our Top Click Group Is <span> Committed To Help Clients </span></h4>
